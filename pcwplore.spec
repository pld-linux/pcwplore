...
Summary(pl.UTF-8):	PCW Explorer - odczyt dyskietek PCW, konwersja obrazków do PNG lub JPG
Name:		pcwplore
Version:	0.02
Release:	1
License:	GPL
...
PCW Explorer potrafi czytać dyskietki PCW i konwertować pliki obrazków
